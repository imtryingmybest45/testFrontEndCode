...
function ThisMovieNameiscompletelydifferentnow(props){

    const origMovName = props.origMovName;
    const movName = "This Movie Name is completely different now";
    const movVal = "But it is still as above, so below....";
...
export default ThisMovieNameiscompletelydifferentnow;