...
function TheAaarvdf(props){

    const origMovName = props.origMovName;
    const movName = "The Aaarvdf";
    const movVal = "great movie, except for the fact that it does unfortunately not exist";
    const movTier = "A";
