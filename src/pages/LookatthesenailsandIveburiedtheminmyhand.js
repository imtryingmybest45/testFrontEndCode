...
function LookatthesenailsandIveburiedtheminmyhand(props){

    const origMovName = props.origMovName;
    const movName = "Look at these nails...and I've buried them in my hand";
    const movVal = "Wow its a neotheo";
...
export default LookatthesenailsandIveburiedtheminmyhand;