...
function FunchytheSnowwomanSheIsMyMom(props){

    const origMovName = props.origMovName;
    const movName = "Funchy the Snowwoman She Is My Mom";
    const movVal = "She is my sister, and I am her mom! Wait, I wish, she was my mom!!!";
...
export default FunchytheSnowwomanSheIsMyMom;