...
function TheAutopsyofjanedoe2Hereitis(props){

    const origMovName = props.origMovName;
    const movName = "The Autopsy of jane doe 2 Here it is";
    const movVal = "Yep, here it is";
...
export default TheAutopsyofjanedoe2Hereitis;