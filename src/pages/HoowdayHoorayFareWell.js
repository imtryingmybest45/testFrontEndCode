...
function HoowdayHoorayFareWell(props){

    const origMovName = props.origMovName;
    const movName = "Hoowday Hooray Fare Well";
    const movVal = "I'm dr. mc bagelface, fare well";
...
export default HoowdayHoorayFareWell;