...
function TheGirlNextDoor2007(props){

    const origMovName = props.origMovName;
    const movName = "The Girl Next Door (2007)";
    const movVal = "This was not a great movie.";
    const movTier = "NO";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNTk4ZmI4YzctNTM5MC00YzY1LThjOTgtZjA5OTcwN2ZjNDFlXkEyXkFqcGdeQXVyMjE0MzE1MA@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheGirlNextDoor2007;