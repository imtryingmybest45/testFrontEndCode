...
function IAmTheManThomasIAmTheMan(props){

    const origMovName = props.origMovName;
    const movName = "I Am The Man Thomas, I Am The Man!";
    const movVal = "Look at these nails";
...
export default IAmTheManThomasIAmTheMan;