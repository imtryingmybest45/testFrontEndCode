...
function Autopsy2HereWeGoAgain(props){

    const origMovName = props.origMovName;
    const movName = "Autopsy 2 Here We Go Again";
    const movVal = "Here is a different erevie, goddamnit. I hope this works.";
...
export default Autopsy2HereWeGoAgain;