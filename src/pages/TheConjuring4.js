...
function TheConjuring4(props){

    const origMovName = props.origMovName;
    const movName = "The Conjuring 4";
    const movVal = "There are so many goddamn conjurings, I don't understand why there needs to be so many.";
