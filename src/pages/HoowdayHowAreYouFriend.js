...
function HoowdayHowAreYouFriend(props){

    const origMovName = props.origMovName;
    const movName = "Hoowday How Are You Friend";
    const movVal = "I'm dr. mc bagelface,hooray";
...
export default HoowdayHowAreYouFriend;