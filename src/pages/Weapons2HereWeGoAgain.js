...
function Weapons2HereWeGoAgain(props){

    const origMovName = props.origMovName;
    const movName = "Weapons 2 Here We Go Again";
    const movVal = "this is a sample review I HAVE EDITED THIS";
...
export default Weapons2HereWeGoAgain;