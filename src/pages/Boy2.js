...
function Boy2(props){
    ...
    const movName = "Boy 2";
    const movVal = "The second iteration of boy";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDc0MjFhN2EtM2U2OS00YmU1LWJjMGYtMzIzOTRjNTM4NDZkXkEyXkFqcGdeQXVyMzI2MTEyMDk@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
