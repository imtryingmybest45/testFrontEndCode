...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 12, text: "Avatar 2", to: "/Avatar2", name: "Avatar 2", moviePoster: 'N/A', tier: 'S'},
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/Avatar2" element={<Avatar2 name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
