...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 12, text: "Unknown Movie", to: "/UnknownMovie", name: "Unknown Movie", moviePoster: boo, tier: 'NO', longReview: 'N',},
      { id: 13, text: "Toy Story", to: "/ToyStory", name: "Toy Story", moviePoster: 'https://m.media-amazon.com/images/M/MV5BZTA3OWVjOWItNjE1NS00NzZiLWE1MjgtZDZhMWI1ZTlkNzYwXkEyXkFqcGc@._V1_SX300.jpg', tier: 'S', longReview: 'Y',},
    ];
