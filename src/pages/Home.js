...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 10, text: 'Annabelle Creation', to: '/AnnabelleCreation', name: "Annabelle Creation" },
      { id: 11, text: 'As Above So Below 2', to: '/AsAboveSoBelow2', name: "As Above So Below 2" },
      { id: 12, text: 'Annabelle Creation', to: '/AnnabelleCreation', name: "Annabelle Creation" },
    ];
