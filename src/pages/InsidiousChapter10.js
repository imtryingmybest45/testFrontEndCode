...
function InsidiousChapter10(props){

    const origMovName = props.origMovName;
    const movName = "Insidious Chapter 10";
    const movVal = "This is the review for Insidious Chapter 4. Huzzah.";
...
export default InsidiousChapter10;