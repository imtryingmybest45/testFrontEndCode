...
function InsidiousTheLastKey(props){

    const origMovName = props.origMovName;
    const movName = "Insidious: The Last Key";
    const movVal = "this was a dumb movie.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTUxODU0NjQ2Nl5BMl5BanBnXkFtZTgwMTc4NDQ0MzI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default InsidiousTheLastKey;