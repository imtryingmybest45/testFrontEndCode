...
function TheConjuringChapter3Again(props){

    const origMovName = props.origMovName;
    const movName = "The Conjuring Chapter 3 Again";
    const movVal = "This is the review for the Conjuring., agian ainga ifnd sa";
...
export default TheConjuringChapter3Again;