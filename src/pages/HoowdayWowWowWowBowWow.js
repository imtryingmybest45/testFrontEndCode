...
function HoowdayWowWowWowBowWow(props){

    const origMovName = props.origMovName;
    const movName = "HoowdayWowWowWow Bow Wow";
    const movVal = "I'm dr. mc bagelfacedksaflkd";
...
export default HoowdayWowWowWowBowWow;